    ...
    <Container className="my-[100px] ">
      <div className="flex flex-row justify-between items-center gap-12 bg-paleIndigo rounded-[40px] overflow-hidden">
        <div className="ml-12 py-15 flex flex-col justify-center items-start">
          <h1 className="font-bold text-[40px] mb-9 bg-deepTeal text-transparent bg-clip-text">Kenalan dulu sama Glamora!</h1>
          <p className="mb-8 text-[20px]">Glamora adalah platform revolusioner di dunia kecantikan dan fashion yang dirancang untuk membantu kamu tampil lebih percaya diri. Terus, apa sih tujuan yang mau Glamora capai? Coba cek di bawah!</p>
